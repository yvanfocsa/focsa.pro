...
const observer = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            entry.target.classList.add('animate-fadeIn'); // Assumes a fade-in animation class
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add hover effect to project cards (this is better handled by CSS :hover pseudo-class as done in style.css)
    // The JavaScript version is kept here as an example if more complex logic were needed.
